...
# Locally test SNS queue 

aws --endpoint-url=http://localhost:4002 sns publish --topic-arn arn:aws:sns:us-east-1:123456789012:test --message '{"default": "hello!"}' --region us-east-1 --profile photobox