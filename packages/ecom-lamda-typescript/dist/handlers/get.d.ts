 ...
 * @param callback
 */
export declare const get: (event: import("aws-lambda").APIGatewayProxyEvent, context: Context, callback: import("aws-lambda").Callback<import("aws-lambda").APIGatewayProxyResult>) => void;
/**
 *
 * @param event
 * @param context
